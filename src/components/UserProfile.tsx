      ...
      {isOpen && (
        <Fragment>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col bg-gray-50 dark:bg-gray-950 shadow-2xl overflow-hidden"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {/* User Details Card */}
              <div className="bg-white dark:bg-gray-900 p-6 mb-2 border-b border-gray-100 dark:border-gray-800">
                {isEditing ? (
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <input 
                          ...
                          className="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 bg-transparent focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white text-gray-900 dark:text-white"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <textarea 
                          ...
                          rows={2}
                          className="w-full text-sm border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2 bg-transparent focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white resize-none text-gray-900 dark:text-white"
                        />
                      </div>
                    </div>
                  ...
                  <>
                    ...
                    <div className="mt-6 flex gap-3">
                      ...
                      <button 
                        ...
                        className="flex items-center justify-center px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors"
                      >
              ...
              <div className="p-6">
                {activeTab === 'orders' ? (
                  <>
                    {orders.length === 0 ? (
                      <div className="flex flex-col items-center justify-center py-10 text-center space-y-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
                      ...
                      <div className="space-y-4">
                        {orders.map((order) => (
                          <div key={order.id} className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div className="bg-gray-50 dark:bg-gray-800/30 px-4 py-3 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
                              <div>
                                ...
                                {order.items.map((item) => (
                                  <li key={item.id} className="flex items-center text-sm">
                                    <img
                                      src={item.image}
                                      alt={item.name}
                                      className="w-12 h-12 rounded-lg object-cover border border-gray-100 dark:border-gray-700 mr-3"
                                    />
                                    ...
                                    <p className="text-gray-900 dark:text-white ml-2 font-medium">${(item.price * item.quantity).toFixed(2)}</p>
                                  </li>
                                ))}
                              </ul>
                  ...
                  <div className="space-y-4">
                    {walletItems.length === 0 ? (
                      ...
                      walletItems.map((item) => (
                        <div key={item.id} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
